            ...
            <div className='row mt-5'>
              <div className='col'>
                <div className='card btn' style={{ width: '12rem', border: 'none' }}>
                  <Image className='card-img-top' src={chinese} width={150} style={{ background: 'none' }} />
                  <h5>Chinese</h5>
                </div>
              </div>
              <div className='col'>
                <div className='card btn' style={{ width: '12rem', border: 'none' }}>
                  <Image className='card-img-top' src={biryani} width={150} height={190} style={{ background: 'none' }} />
                  <h5>Biryani</h5>
                </div>
              </div>
              <div className='col'>
                <div className='card btn' style={{ width: '12rem', border: 'none' }}>
                  <Image className='card-img-top' src={burger} width={150} height={190} style={{ background: 'none' }} />
                  <h5>Burger</h5>
                </div>
              </div>
              <div className='col'>
                <div className='card btn' style={{ width: '12rem', border: 'none' }}>
                  <Image className='card-img-top' src={rolls} width={150} height={190} style={{ background: 'none' }} />
                  <h5>Rolls</h5>
                </div>
              </div>
              <div className='col'>
                <div className='card btn' style={{ width: '12rem', border: 'none' }}>
                  <Image className='card-img-top' src={pizza} width={150} height={190} style={{ background: 'none' }} />
                  <h5>Pizza</h5>
                </div>
              </div>
            </div>
                    ...
                    <Link href={'/Resturent'} style={{ textDecoration: 'none', color: 'black' }}>
                      <div className={styles.card} style={{ width: '12rem', margin: '35px' }}>
                        <div className='card-img-top'>
                          <Image src={item.images} width={190} height={175} priority />
                        </div>
